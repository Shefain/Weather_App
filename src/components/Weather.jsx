...
const Weather = () => {
  ...
  return (
    <div className=" place-self-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-xl flex flex-col items-center pb-8">
      ...
      <img className="w-[150px] mtb-8 " src={`https://openweathermap.org/img/wn/${weatherData.icon}.png`} />
      <p className="text-white text-[48px] leading-10 mt-8">{Math.floor(weatherData.temp)}°</p>
